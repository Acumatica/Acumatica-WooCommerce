...
<p>4. Select the payment methods as&nbsp;<a class="external-link" href="http://authorize.net/" rel="nofollow">Authorize.net</a>&nbsp;and enter a card id (Don't enable save card option). Then capture the payment by changing the order 'Status' as 'Processing or 'Completed'</p>
