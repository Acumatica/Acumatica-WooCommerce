...
{
    [JsonObject(Description = "Customer -> Shipping Address")]
    [CommerceDescription(WCCaptions.OrderShippingAddressData)]
    public class ShippingAddressData : BCAPIEntity, IEquatable<ShippingAddressData>
    {
        ...
        public bool Equals(ShippingAddressData newObject)
        {
            var oldObject = this;
        ...
        public int? GetHashCode(ShippingAddressData obj)
        {
