...
{
    [JsonObject(Description = Messages.Order)]
    public class OrderData : IBCEntityData
    {
        public OrderData()
        {
        ...
        /// from Order Statuses
        /// </summary>
        [JsonProperty("status_id", DefaultValueHandling = DefaultValueHandling.Include)]
        ...
        public virtual IList<OrderProductData> Products { get; set; }
