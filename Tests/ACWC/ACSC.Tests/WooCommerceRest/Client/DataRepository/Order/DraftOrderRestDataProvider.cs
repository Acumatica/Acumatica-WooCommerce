...
namespace ACSC.Tests.ShopifyRest.Client.DataRepository.Order
{
    ...
    {
        protected override string GetListUrl { get; } = "draft_orders.json";
        protected override string GetSingleUrl { get; } = "draft_orders/{id}.json";
        protected override string GetCountUrl { get; } = "draft_orders/count.json";
        protected override string GetSearchUrl => throw new NotImplementedException();
        private string CompleteUrl { get; } = "draft_orders/{id}/complete.json";
