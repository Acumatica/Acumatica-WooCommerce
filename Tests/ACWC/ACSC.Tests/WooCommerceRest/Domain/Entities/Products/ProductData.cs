...
namespace ACSC.Tests.ShopifyRest.Domain.Entities.Products
{
    ...
    public class ProductData
    {
        ...
        [Description(ShopifyCaptions.ProductName)]
        ...
        [JsonProperty("sku")]
        [Description(ShopifyCaptions.StockKeepingUnit)]
        public string Sku { get; set; }

        [JsonProperty("description")]
        [Description(ShopifyCaptions.ProductDescription)]
        ...
        [Description(ShopifyCaptions.RegularPrice)]
