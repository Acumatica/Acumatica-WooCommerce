...
namespace ACBC.Tests.Wrappers
{
    ...
    public class SO302000_SOShipmentEntry : Wrapper
    {
        ...
        public virtual void ConfirmShipmentActionHidden()
        {
            ToolBar.ConfirmShipmentActionHidden.Click();
        }
        
        public virtual void ConfirmShipmentActionHidden(bool status, string message = null)
        {
            ToolBar.ConfirmShipmentActionHidden.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.ConfirmShipmentActionHidden.Click();
        }
        
        public virtual void CreateInvoiceHidden()
        {
            ToolBar.CreateInvoiceHidden.Click();
        }
        
        public virtual void CreateInvoiceHidden(bool status, string message = null)
        {
            ToolBar.CreateInvoiceHidden.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.CreateInvoiceHidden.Click();
        }
        
        public virtual void CreateDropshipInvoiceHidden()
        {
            ToolBar.CreateDropshipInvoiceHidden.Click();
        }
        
        public virtual void CreateDropshipInvoiceHidden(bool status, string message = null)
        {
            ToolBar.CreateDropshipInvoiceHidden.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.CreateDropshipInvoiceHidden.Click();
        }
        
        public virtual void UpdateINHidden()
        {
            ToolBar.UpdateINHidden.Click();
        }
        
        public virtual void CorrectShipmentActionHidden()
        {
            ToolBar.CorrectShipmentActionHidden.Click();
        }
        
        public virtual void CorrectShipmentActionHidden(bool status, string message = null)
        {
            ToolBar.CorrectShipmentActionHidden.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.CorrectShipmentActionHidden.Click();
        }
        
        public virtual void PrintLabelsHidden()
        {
            ToolBar.PrintLabelsHidden.Click();
        }
        
        public virtual void PrintLabelsHidden(bool status, string message = null)
        {
            ToolBar.PrintLabelsHidden.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.PrintLabelsHidden.Click();
        }
        
        public virtual void GetReturnLabelsActionHidden()
        {
            ToolBar.GetReturnLabelsActionHidden.Click();
        }
        
        public virtual void GetReturnLabelsActionHidden(bool status, string message = null)
        {
            ToolBar.GetReturnLabelsActionHidden.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.GetReturnLabelsActionHidden.Click();
        }
        
        public virtual void CancelReturnHidden()
        {
            ToolBar.CancelReturnHidden.Click();
        }
        
        public virtual void CancelReturnHidden(bool status, string message = null)
        {
            ToolBar.CancelReturnHidden.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.CancelReturnHidden.Click();
        }
        
        public virtual void EmailShipmentHidden()
        {
            ToolBar.EmailShipmentHidden.Click();
        }
        
        public virtual void PrintPickListActionHidden()
        {
            ToolBar.PrintPickListActionHidden.Click();
        }
        ...
        public virtual void PrintShipmentConfirmationHidden()
        {
            ToolBar.PrintShipmentConfirmationHidden.Click();
        }
        ...
        public virtual void CorrectShipmentAction(bool status, string message = null)
        {
            ToolBar.CorrectShipmentAction.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.CorrectShipmentAction.Click();
        }
        ...
        public virtual void UnlinkFromWorksheetHidden()
        {
            ToolBar.UnlinkFromWorksheetHidden.Click();
        }
        ...
        public class PxToolBar : PxControlCollection
        {
			...
			public ToolBarButton ConfirmShipmentActionHidden { get; }
			public ToolBarButton CreateInvoiceHidden { get; }
			public ToolBarButton CreateDropshipInvoiceHidden { get; }
			public ToolBarButton UpdateINHidden { get; }
			public ToolBarButton CorrectShipmentActionHidden { get; }
			public ToolBarButton PrintLabelsHidden { get; }
			public ToolBarButton GetReturnLabelsActionHidden { get; }
			public ToolBarButton CancelReturnHidden { get; }
			public ToolBarButton EmailShipmentHidden { get; }
			public ToolBarButton PrintPickListActionHidden { get; }
			public ToolBarButton PutOnHoldHidden { get; }
			public ToolBarButton ReleaseFromHoldHidden { get; }
			public ToolBarButton PrintShipmentConfirmationHidden { get; }
			...
			public ToolBarButton UnlinkFromWorksheetHidden { get; }
            ...
            public PxToolBar(string locator)
            {
                ...
                ConfirmShipmentActionHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'ConfirmShipmentAction\']", "Confirm Shipment", locator, null);
                ConfirmShipmentActionHidden.WaitAction = Wait.WaitForLongOperationToComplete;
                CreateInvoiceHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'CreateInvoice\']", "Prepare Invoice", locator, null);
                CreateInvoiceHidden.WaitAction = Wait.WaitForLongOperationToComplete;
                CreateDropshipInvoiceHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'CreateDropshipInvoice\']", "Prepare Drop-Ship Invoice", locator, null);
                CreateDropshipInvoiceHidden.WaitAction = Wait.WaitForLongOperationToComplete;
                UpdateINHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'updateIN\']", "Update IN", locator, null);
                CorrectShipmentActionHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'CorrectShipmentAction\']", "Correct Shipment", locator, null);
                CorrectShipmentActionHidden.WaitAction = Wait.WaitForLongOperationToComplete;
                PrintLabelsHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'PrintLabels\']", "Print Labels", locator, null);
                PrintLabelsHidden.WaitAction = Wait.WaitForLongOperationToComplete;
                GetReturnLabelsActionHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'GetReturnLabelsAction\']", "Get Return Labels", locator, null);
                GetReturnLabelsActionHidden.WaitAction = Wait.WaitForLongOperationToComplete;
                CancelReturnHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'CancelReturn\']", "Cancel Return", locator, null);
                CancelReturnHidden.WaitAction = Wait.WaitForLongOperationToComplete;
                EmailShipmentHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'EmailShipment\']", "Email Shipment", locator, null);
                PrintPickListActionHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'PrintPickListAction\']", "Print Pick List", locator, null);
                ...
                PrintShipmentConfirmationHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'PrintShipmentConfirmation\']", "Print Shipment Confirmation", locator, null);
                ...
                ConfirmShipmentAction = new ToolBarButton("css=li[data-cmd=\'Action@ConfirmShipmentAction\']", "Confirm Shipment", locator, Actions);
                ConfirmShipmentAction.WaitAction = Wait.WaitForLongOperationToComplete;
                CreateInvoice = new ToolBarButton("css=li[data-cmd=\'Action@CreateInvoice\']", "Prepare Invoice", locator, Actions);
                CreateInvoice.WaitAction = Wait.WaitForLongOperationToComplete;
                CreateDropshipInvoice = new ToolBarButton("css=li[data-cmd=\'Action@CreateDropshipInvoice\']", "Prepare Drop-Ship Invoice", locator, Actions);
                CreateDropshipInvoice.WaitAction = Wait.WaitForLongOperationToComplete;
                UpdateIN = new ToolBarButton("css=li[data-cmd=\'Action@updateIN\']", "Update IN", locator, Actions);
                CorrectShipmentAction = new ToolBarButton("css=li[data-cmd=\'Action@CorrectShipmentAction\']", "Correct Shipment", locator, Actions);
                CorrectShipmentAction.WaitAction = Wait.WaitForLongOperationToComplete;
                PrintLabels = new ToolBarButton("css=li[data-cmd=\'Action@PrintLabels\']", "Print Labels", locator, Actions);
                PrintLabels.WaitAction = Wait.WaitForLongOperationToComplete;
                GetReturnLabelsAction = new ToolBarButton("css=li[data-cmd=\'Action@GetReturnLabelsAction\']", "Get Return Labels", locator, Actions);
                GetReturnLabelsAction.WaitAction = Wait.WaitForLongOperationToComplete;
                CancelReturn = new ToolBarButton("css=li[data-cmd=\'Action@CancelReturn\']", "Cancel Return", locator, Actions);
                ...
                EmailShipment = new ToolBarButton("css=li[data-cmd=\'Action@EmailShipment\']", "Email Shipment", locator, Actions);
                PrintPickListAction = new ToolBarButton("css=li[data-cmd=\'Action@PrintPickListAction\']", "Print Pick List", locator, Actions);
                ...
                UnlinkFromWorksheet = new ToolBarButton("css=li[data-cmd=\'Action@unlinkFromWorksheet\']", "Remove From Worksheet", locator, Actions);
                ...
                PrintShipmentConfirmation = new ToolBarButton("css=li[data-cmd=\'Report@PrintShipmentConfirmation\']", "Print Shipment Confirmation", locator, Reports);
                UnlinkFromWorksheetHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'unlinkFromWorksheet\']", "Remove From Worksheet", locator, null);
        ...
        public class c_document_form : Container
        {
			...
			public Button CurrentWorksheetNbrEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    CurrentWorksheetNbrEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                }
            }
        }
        ...
        public class c_shipping_contact_formd : Container
        {
                    ...
                    base(locator, name)
            {
                ...
                FullName = new PXTextEdit("ctl00_phG_tab_t2_formD_edFullName", "Company Name", locator, null);
        ...
        public class c_packagesforrates_gridpackagesforrates : Grid<c_packagesforrates_gridpackagesforrates.c_grid_row, c_packagesforrates_gridpackagesforrates.c_grid_header>
        {
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    ...
                    Hi1 = new ToolBarButtonGrid("css=#ctl00_phG_PanelCarrierRates_gridPackagesForRates_ab_tlb div[data-cmd=\'hi\']", "Hi", locator, null);
                }
            }
