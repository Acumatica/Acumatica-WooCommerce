...
namespace ACBC.Tests.Wrappers
{
    ...
    public class IN201000_INItemClassMaint : Wrapper
    {
        ...
        public virtual void ResetGroupHidden()
        {
            ToolBar.ResetGroupHidden.Click();
        }
        
        public virtual void ResetGroupHidden(bool status, string message = null)
        {
            ToolBar.ResetGroupHidden.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.ResetGroupHidden.Click();
        }
        
        public virtual void ApplyToChildrenHidden()
        {
            ToolBar.ApplyToChildrenHidden.Click();
        }
        ...
        public class PxToolBar : PxControlCollection
        {
			...
			public ToolBarButton ResetGroupHidden { get; }
			public ToolBarButton ApplyToChildrenHidden { get; }
            ...
            public PxToolBar(string locator)
            {
                ...
                ResetGroupHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'ResetGroup\']", "Apply Restriction Settings to All Inventory Items", locator, null);
                ResetGroupHidden.WaitAction = Wait.WaitForLongOperationToComplete;
                ApplyToChildrenHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'ApplyToChildren\']", "Apply to Children", locator, null);
                ...
                ApplyToChildren = new ToolBarButton("css=li[data-cmd=\'Action@ApplyToChildren\']", "Apply to Children", locator, Actions);
                ChangeID = new ToolBarButton("css=li[data-cmd=\'Action@ChangeID\']", "Change ID", locator, Actions);
                ResetGroup = new ToolBarButton("css=li[data-cmd=\'Action@ResetGroup\']", "Apply Restriction Settings to All Inventory Items", locator, Actions);
        ...
        public class c_itemclasssettings_tab : Container
        {
                    ...
                    base(locator, name)
            {
                ...
                DfltSiteID = new Selector("ctl00_phG_sp1_scrollForm_tab_t0_edDfltSiteID", "Default Warehouse", locator, null);
			...
			public Button PriceManagerIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    DfltSiteIDEdit = new Button("css=div[id=\'ctl00_phG_sp1_scrollForm_tab_t0_edDfltSiteID\'] div[class=\'editBtnCont" +
                            "\'] > div > div", "DfltSiteIDEdit", "ctl00_phG_sp1_scrollForm_tab");
                    ...
                    AvailabilitySchemeIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
