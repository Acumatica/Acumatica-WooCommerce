...
namespace ACSC.Tests.Wrappers.Customer
{
    ...
    public class AR3030PL_PXGenericInqGrph : Wrapper
    {
        ...
        public AR3030PL_PXGenericInqGrph()
        {
            ScreenId = "AR3030PL";
            ScreenUrl = "/GenericInquiry/GenericInquiry.aspx?id=8b5104f6-326b-4194-a29e-b424601e5b61";
        ...
        public class c_results_grid : Grid<c_results_grid.c_grid_row, c_results_grid.c_grid_header>
        {
			...
			public Selector Customer_acctName { get; }
			public Selector Customer_customerClassID { get; }
			public Selector Address_countryID { get; }
			public PXTextEdit Address_city { get; }
			public Selector Customer_curyID { get; }
			public Selector Customer_termsID { get; }
			public DropDown Customer_status { get; }
			public Selector BAccountR_acctCD { get; }
			public DateSelector Customer_createdDateTime { get; }
			public DateSelector Customer_lastModifiedDateTime { get; }
			public PXNumberEdit Address_AddressID { get; }
                        ...
                        base(grid)
                {
                    ...
                    Customer_acctName = new Selector("_ctl00_phG_grid_lv0_es", "Customer Name", grid.Locator, "Customer_acctName");
                    Customer_acctName.DataField = "Customer_acctName";
                    Customer_customerClassID = new Selector("_ctl00_phG_grid_lv0_es", "Customer Class", grid.Locator, "Customer_customerClassID");
                    Customer_customerClassID.DataField = "Customer_customerClassID";
                    Address_countryID = new Selector("_ctl00_phG_grid_lv0_es", "Country", grid.Locator, "Address_countryID");
                    Address_countryID.DataField = "Address_countryID";
                    Address_city = new PXTextEdit("ctl00_phG_grid_ei", "City", grid.Locator, "Address_city");
                    Address_city.DataField = "Address_city";
                    Customer_curyID = new Selector("_ctl00_phG_grid_lv0_es", "Currency ID", grid.Locator, "Customer_curyID");
                    Customer_curyID.DataField = "Customer_curyID";
                    Customer_termsID = new Selector("_ctl00_phG_grid_lv0_es", "Terms", grid.Locator, "Customer_termsID");
                    Customer_termsID.DataField = "Customer_termsID";
                    Customer_status = new DropDown("_ctl00_phG_grid_lv0_ec", "Status", grid.Locator, "Customer_status");
                    Customer_status.DataField = "Customer_status";
                    Customer_status.Items.Add("A", "Active");
                    Customer_status.Items.Add("H", "On Hold");
                    Customer_status.Items.Add("C", "Credit Hold");
                    Customer_status.Items.Add("I", "Inactive");
                    Customer_status.Items.Add("T", "One-Time");
                    BAccountR_acctCD = new Selector("_ctl00_phG_grid_lv0_edBAccountR_acctCD", "Parent Account", grid.Locator, "BAccountR_acctCD");
                    BAccountR_acctCD.DataField = "BAccountR_acctCD";
                    Customer_createdDateTime = new DateSelector("_ctl00_phG_grid_lv0_ed13", "Created On", grid.Locator, "Customer_createdDateTime");
                    Customer_createdDateTime.DataField = "Customer_createdDateTime";
                    Customer_lastModifiedDateTime = new DateSelector("_ctl00_phG_grid_lv0_ed14", "Last Modified On", grid.Locator, "Customer_lastModifiedDateTime");
                    Customer_lastModifiedDateTime.DataField = "Customer_lastModifiedDateTime";
                    Address_AddressID = new PXNumberEdit("ctl00_phG_grid_en", "Address ID", grid.Locator, "Address_AddressID");
                    Address_AddressID.DataField = "Address_AddressID";
                }
            }
            ...
            public class c_grid_header : GridHeader
            {
				...
				public InputColumnFilter Customer_acctName { get; }
				public SelectorColumnFilter Customer_customerClassID { get; }
				public SelectorColumnFilter Address_countryID { get; }
				public PXTextEditColumnFilter Address_city { get; }
				public SelectorColumnFilter Customer_curyID { get; }
				public SelectorColumnFilter Customer_termsID { get; }
				public DropDownColumnFilter Customer_status { get; }
				public SelectorColumnFilter BAccountR_acctCD { get; }
				public DateSelectorColumnFilter Customer_createdDateTime { get; }
				public DateSelectorColumnFilter Customer_lastModifiedDateTime { get; }
				public PXNumberEditColumnFilter Address_AddressID { get; }
                        ...
                        base(grid)
                {
                    ...
                    Customer_acctName = new InputColumnFilter(grid.Row.Customer_acctName);
                    Customer_customerClassID = new SelectorColumnFilter(grid.Row.Customer_customerClassID);
                    Address_countryID = new SelectorColumnFilter(grid.Row.Address_countryID);
                    Address_city = new PXTextEditColumnFilter(grid.Row.Address_city);
                    Customer_curyID = new SelectorColumnFilter(grid.Row.Customer_curyID);
                    Customer_termsID = new SelectorColumnFilter(grid.Row.Customer_termsID);
                    Customer_status = new DropDownColumnFilter(grid.Row.Customer_status);
                    BAccountR_acctCD = new SelectorColumnFilter(grid.Row.BAccountR_acctCD);
                    Customer_createdDateTime = new DateSelectorColumnFilter(grid.Row.Customer_createdDateTime);
                    Customer_lastModifiedDateTime = new DateSelectorColumnFilter(grid.Row.Customer_lastModifiedDateTime);
                    Address_AddressID = new PXNumberEditColumnFilter(grid.Row.Address_AddressID);
                }
            }
        }
        ...
        public class c_results_lv0 : Container
        {
			...
			public Selector BAccountR_acctCD { get; }
			public Label BAccountR_acctCDLabel { get; }
			public Selector Es { get; }
			public Label EsLabel { get; }
            ...
            public c_results_lv0(string locator, string name) : 
                    base(locator, name)
            {
                BAccountR_acctCD = new Selector("ctl00_phG_grid_lv0_edBAccountR_acctCD", "B Account R _acct CD", locator, null);
                BAccountR_acctCDLabel = new Label(BAccountR_acctCD);
                BAccountR_acctCD.DataField = "BAccountR_acctCD";
            ...
            public virtual void BAccountR_acctCDEdit()
            {
                Buttons.BAccountR_acctCDEdit.Click();
            }
            
            public class PxButtonCollection : PxControlCollection
            {
                
			public Button BAccountR_acctCDEdit { get; }
                
                public PxButtonCollection()
                {
                    BAccountR_acctCDEdit = new Button("css=div[id=\'ctl00_phG_grid_lv0_edBAccountR_acctCD\'] div[class=\'editBtnCont\'] > di" +
                            "v > div", "BAccountR_acctCDEdit", "ctl00_phG_grid_lv0");
                    BAccountR_acctCDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                }
            }
        }
