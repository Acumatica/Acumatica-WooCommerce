...
namespace ACSC.Tests.Wrappers.Customer
{
    ...
    public class TX2060PL_PXGenericInqGrph : Wrapper
    {
        ...
        public TX2060PL_PXGenericInqGrph()
        {
            ScreenId = "TX2060PL";
            ScreenUrl = "/GenericInquiry/GenericInquiry.aspx?id=f1a3f440-8f5e-4766-8249-a005b9443ed1";
        ...
        public class c_results_grid : Grid<c_results_grid.c_grid_row, c_results_grid.c_grid_header>
        {
			...
			public Selector TaxZone_TaxZoneID { get; }
			public PXTextEdit TaxZone_descr { get; }
			public Selector TaxZone_dfltTaxCategoryID { get; }
                        ...
                        base(grid)
                {
                    ...
                    Row.DataField = "Row";
                    TaxZone_TaxZoneID = new Selector("_ctl00_phG_grid_lv0_es", "Tax Zone ID", grid.Locator, "TaxZone_TaxZoneID");
                    TaxZone_TaxZoneID.DataField = "TaxZone_TaxZoneID";
                    TaxZone_descr = new PXTextEdit("ctl00_phG_grid_ei", "Description", grid.Locator, "TaxZone_descr");
                    TaxZone_descr.DataField = "TaxZone_descr";
                    TaxZone_dfltTaxCategoryID = new Selector("_ctl00_phG_grid_lv0_es", "Default Tax Category", grid.Locator, "TaxZone_dfltTaxCategoryID");
                    TaxZone_dfltTaxCategoryID.DataField = "TaxZone_dfltTaxCategoryID";
                }
            }
            ...
            public class c_grid_header : GridHeader
            {
				...
				public SelectorColumnFilter TaxZone_TaxZoneID { get; }
				public PXTextEditColumnFilter TaxZone_descr { get; }
				public SelectorColumnFilter TaxZone_dfltTaxCategoryID { get; }
                        ...
                        base(grid)
                {
                    ...
                    TaxZone_TaxZoneID = new SelectorColumnFilter(grid.Row.TaxZone_TaxZoneID);
                    TaxZone_descr = new PXTextEditColumnFilter(grid.Row.TaxZone_descr);
                    TaxZone_dfltTaxCategoryID = new SelectorColumnFilter(grid.Row.TaxZone_dfltTaxCategoryID);
                }
            }
        }
