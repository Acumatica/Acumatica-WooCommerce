...
namespace ACBC.Tests.Wrappers
{
    ...
    public class CS208000_ShipTermsMaint : Wrapper
    {
        ...
        protected c_shiptermscurrent_form ShipTermsCurrent_form { get; } = new c_shiptermscurrent_form("ctl00_phF_form", "ShipTermsCurrent_form");
        ...
        protected c_shiptermsdetail_grid ShipTermsDetail_grid { get; } = new c_shiptermsdetail_grid("ctl00_phG_grid", "ShipTermsDetail_grid");
        protected c_shiptermsdetail_lv0 ShipTermsDetail_lv0 { get; } = new c_shiptermsdetail_lv0("ctl00_phG_grid_lv0", "ShipTermsDetail_lv0");
        protected c_filterpreview_formpreview FilterPreview_FormPreview { get; } = new c_filterpreview_formpreview("ctl00_usrCaption_PanelDynamicForm_FormPreview", "FilterPreview_FormPreview");
        
        public CS208000_ShipTermsMaint()
        {
            ScreenId = "CS208000";
            ScreenUrl = "/Pages/CS/CS208000.aspx";
        ...
        public virtual CS208000_ShipTermsMaint ReadOne(Gate gate, string ShipTermsID)
        {
            new BiObject<CS208000_ShipTermsMaint>(gate).ReadOne(this, ShipTermsID);
            return this;
        }
        
        public virtual CS208000_ShipTermsMaint ReadOne(string ShipTermsID)
        {
            return this.ReadOne(ApiConnection.Source, ShipTermsID);
        }
        ...
        public class c_shiptermscurrent_form : Container
        {
            ...
            public c_shiptermscurrent_form(string locator, string name) : 
                    base(locator, name)
            {
                ShipTermsID = new Selector("ctl00_phF_form_edShipTermsID", "Term ID", locator, null);
                ...
                FreightAmountSource = new DropDown("ctl00_phF_form_edFreightAmountSource", "Invoice Freight Price Based On", locator, null);
                ...
                DataMemberName = "ShipTermsCurrent";
            }
        }
        ...
        public class c_shiptermsdetail_grid : Grid<c_shiptermsdetail_grid.c_grid_row, c_shiptermsdetail_grid.c_grid_header>
        {
            ...
            public c_shiptermsdetail_grid(string locator, string name) : 
                    base(locator, name)
            {
                ToolBar = new PxToolBar("ctl00_phG_grid");
                DataMemberName = "ShipTermsDetail";
			...
			public PXNumberEdit BreakAmount { get; }
			public PXNumberEdit FreightCostPercent { get; }
			public PXNumberEdit InvoiceAmountPercent { get; }
			public PXNumberEdit ShippingHandling { get; }
			public PXNumberEdit LineHandling { get; }
			public PXTextEdit ShipTermsID { get; }
			public PXNumberEdit LineNbr { get; }
                
                public c_grid_row(c_shiptermsdetail_grid grid) : 
                        base(grid)
                {
                    BreakAmount = new PXNumberEdit("_ctl00_phG_grid_lv0_edBreakAmount", "Break Amount", grid.Locator, "BreakAmount");
                    BreakAmount.DataField = "BreakAmount";
                    FreightCostPercent = new PXNumberEdit("_ctl00_phG_grid_lv0_edFreightCostPercent", "Freight Cost %", grid.Locator, "FreightCostPercent");
                    FreightCostPercent.DataField = "FreightCostPercent";
                    InvoiceAmountPercent = new PXNumberEdit("_ctl00_phG_grid_lv0_edInvoiceAmountPercent", "Invoice Amount %", grid.Locator, "InvoiceAmountPercent");
                    InvoiceAmountPercent.DataField = "InvoiceAmountPercent";
                    ShippingHandling = new PXNumberEdit("_ctl00_phG_grid_lv0_edShippingHandling", "Shipping and Handling", grid.Locator, "ShippingHandling");
                    ShippingHandling.DataField = "ShippingHandling";
                    LineHandling = new PXNumberEdit("_ctl00_phG_grid_lv0_edLineHandling", "Line Handling", grid.Locator, "LineHandling");
                    LineHandling.DataField = "LineHandling";
                    ShipTermsID = new PXTextEdit("ctl00_phG_grid_em", "ShipTermsID", grid.Locator, "ShipTermsID");
                    ShipTermsID.DataField = "ShipTermsID";
                    LineNbr = new PXNumberEdit("ctl00_phG_grid_en", "LineNbr", grid.Locator, "LineNbr");
            ...
            public class c_grid_header : GridHeader
            {
				...
				public PXNumberEditColumnFilter BreakAmount { get; }
				public PXNumberEditColumnFilter FreightCostPercent { get; }
				public PXNumberEditColumnFilter InvoiceAmountPercent { get; }
				public PXNumberEditColumnFilter ShippingHandling { get; }
				public PXNumberEditColumnFilter LineHandling { get; }
				public PXTextEditColumnFilter ShipTermsID { get; }
				public PXNumberEditColumnFilter LineNbr { get; }
                
                public c_grid_header(c_shiptermsdetail_grid grid) : 
                        base(grid)
                {
                    BreakAmount = new PXNumberEditColumnFilter(grid.Row.BreakAmount);
                    FreightCostPercent = new PXNumberEditColumnFilter(grid.Row.FreightCostPercent);
                    InvoiceAmountPercent = new PXNumberEditColumnFilter(grid.Row.InvoiceAmountPercent);
                    ShippingHandling = new PXNumberEditColumnFilter(grid.Row.ShippingHandling);
                    LineHandling = new PXNumberEditColumnFilter(grid.Row.LineHandling);
                    ShipTermsID = new PXTextEditColumnFilter(grid.Row.ShipTermsID);
                    LineNbr = new PXNumberEditColumnFilter(grid.Row.LineNbr);
                }
            }
        }
        
        public class c_shiptermsdetail_lv0 : Container
        {
            
			public PXNumberEdit BreakAmount { get; }
			public Label BreakAmountLabel { get; }
			public PXNumberEdit FreightCostPercent { get; }
			public Label FreightCostPercentLabel { get; }
			public PXNumberEdit InvoiceAmountPercent { get; }
			public Label InvoiceAmountPercentLabel { get; }
			public PXNumberEdit ShippingHandling { get; }
			public Label ShippingHandlingLabel { get; }
			public PXNumberEdit LineHandling { get; }
			public Label LineHandlingLabel { get; }
            
            public c_shiptermsdetail_lv0(string locator, string name) : 
                    base(locator, name)
            {
                BreakAmount = new PXNumberEdit("ctl00_phG_grid_lv0_edBreakAmount", "Break Amount", locator, null);
                BreakAmountLabel = new Label(BreakAmount);
                BreakAmount.DataField = "BreakAmount";
                FreightCostPercent = new PXNumberEdit("ctl00_phG_grid_lv0_edFreightCostPercent", "Freight Cost %", locator, null);
                FreightCostPercentLabel = new Label(FreightCostPercent);
                FreightCostPercent.DataField = "FreightCostPercent";
                InvoiceAmountPercent = new PXNumberEdit("ctl00_phG_grid_lv0_edInvoiceAmountPercent", "Invoice Amount %", locator, null);
                InvoiceAmountPercentLabel = new Label(InvoiceAmountPercent);
                InvoiceAmountPercent.DataField = "InvoiceAmountPercent";
                ShippingHandling = new PXNumberEdit("ctl00_phG_grid_lv0_edShippingHandling", "Shipping and Handling", locator, null);
                ShippingHandlingLabel = new Label(ShippingHandling);
                ShippingHandling.DataField = "ShippingHandling";
                LineHandling = new PXNumberEdit("ctl00_phG_grid_lv0_edLineHandling", "Line Handling", locator, null);
                LineHandlingLabel = new Label(LineHandling);
                LineHandling.DataField = "LineHandling";
                DataMemberName = "ShipTermsDetail";
            }
        }
