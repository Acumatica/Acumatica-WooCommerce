...
namespace ACBC.Tests.Wrappers
{
    ...
    public class AR202000_ARSalesPriceMaint : Wrapper
    {
        ...
        protected c_records_grid Records_grid { get; } = new c_records_grid("ctl00_phG_grid", "Records_grid");
        protected c_records_lv0 Records_lv0 { get; } = new c_records_lv0("ctl00_phG_grid_lv0", "Records_lv0");
        protected c_filterpreview_formpreview FilterPreview_FormPreview { get; } = new c_filterpreview_formpreview("ctl00_usrCaption_PanelDynamicForm_FormPreview", "FilterPreview_FormPreview");
        
        public AR202000_ARSalesPriceMaint()
        {
            ScreenId = "AR202000";
            ScreenUrl = "/Pages/AR/AR202000.aspx";
        ...
        public class PxToolBar : PxControlCollection
        {
			...
			public ToolBarButton CreateWorksheet { get; }
            ...
            public PxToolBar(string locator)
            {
                ...
                CreateWorksheet = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'CreateWorksheet\']", "Create Price Worksheet", locator, null);
        ...
        public class c_filter_form : Container
        {
			...
			public DropDown PriceType { get; }
			public Label PriceTypeLabel { get; }
			public Selector PriceCode { get; }
			public Label PriceCodeLabel { get; }
			public DateSelector EffectiveAsOfDate { get; }
			public Label EffectiveAsOfDateLabel { get; }
			...
			public Selector InventoryPriceClassID { get; }
			public Label InventoryPriceClassIDLabel { get; }
            ...
            public c_filter_form(string locator, string name) : 
                    base(locator, name)
            {
                PriceType = new DropDown("ctl00_phF_form_ddPriceType", "Price Type", locator, null);
                PriceTypeLabel = new Label(PriceType);
                PriceType.DataField = "PriceType";
                PriceType.Items.Add("A", "All Prices");
                PriceType.Items.Add("B", "Base");
                PriceType.Items.Add("C", "Customer");
                PriceType.Items.Add("P", "Customer Price Class");
                PriceCode = new Selector("ctl00_phF_form_edPriceCode", "Price Code", locator, null);
                PriceCodeLabel = new Label(PriceCode);
                PriceCode.DataField = "PriceCode";
                EffectiveAsOfDate = new DateSelector("ctl00_phF_form_edEffectiveAsOfDate", "Effective As Of", locator, null);
                EffectiveAsOfDateLabel = new Label(EffectiveAsOfDate);
                EffectiveAsOfDate.DataField = "EffectiveAsOfDate";
                ItemClassCD = new Selector("ctl00_phF_form_edItemClassID", "Item Class ID", locator, null);
                ...
                InventoryPriceClassID = new Selector("ctl00_phF_form_edInventoryPriceClassID", "Price Class", locator, null);
                InventoryPriceClassIDLabel = new Label(InventoryPriceClassID);
                InventoryPriceClassID.DataField = "InventoryPriceClassID";
                OwnerID = new Selector("ctl00_phF_form_edPriceManagerID", "Price Manager", locator, null);
                OwnerIDLabel = new Label(OwnerID);
                OwnerID.DataField = "OwnerID";
                MyOwner = new CheckBox("ctl00_phF_form_chkMyUser", "Me", locator, null);
                MyOwnerLabel = new Label(MyOwner);
                MyOwner.DataField = "MyOwner";
                WorkGroupID = new Selector("ctl00_phF_form_edWorkGroupID", "Price Workgroup", locator, null);
        ...
        public class c_records_grid : Grid<c_records_grid.c_grid_row, c_records_grid.c_grid_header>
        {
                    ...
                    base(locator, name)
            {
                ...
                PredefinedFilter = new DropDown("ctl00_phG_grid_at_tlb_fs", "Predefined Filter", locator, null);
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    ...
                    Filter = new ToolBarButtonGrid("css=#ctl00_phG_grid_at_tlb div[data-cmd=\'FilterShow\']", "Filter Settings", locator, null);
			...
			public Selector SiteID { get; }
			public CheckBox IsPromotionalPrice { get; }
			public CheckBox IsFairValue { get; }
			public CheckBox IsProrated { get; }
			public PXNumberEdit BreakQty { get; }
			public PXNumberEdit SalesPrice { get; }
			...
			public PXNumberEdit RecordID { get; }
                        ...
                        base(grid)
                {
                    ...
                    PriceType = new DropDown("_ctl00_phG_grid_lv0_ec", "Price Type", grid.Locator, "PriceType");
                    PriceType.DataField = "PriceType";
                    PriceType.Items.Add("B", "Base");
                    PriceType.Items.Add("C", "Customer");
                    PriceType.Items.Add("P", "Customer Price Class");
                    PriceCode = new Selector("_ctl00_phG_grid_lv0_edPriceCode", "Price Code", grid.Locator, "PriceCode");
                    PriceCode.DataField = "PriceCode";
                    AlternateID = new PXTextEdit("ctl00_phG_grid_ei", "Alternate ID", grid.Locator, "AlternateID");
                    ...
                    InventoryID.DataField = "InventoryID";
                    InventoryID_InventoryItem_Descr = new PXTextEdit("ctl00_phG_grid_ei", "Description", grid.Locator, "InventoryID_InventoryItem_Descr");
                    InventoryID_InventoryItem_Descr.DataField = "InventoryID_InventoryItem_Descr";
                    UOM = new Selector("_ctl00_phG_grid_lv0_es", "UOM", grid.Locator, "UOM");
                    UOM.DataField = "UOM";
                    SiteID = new Selector("_ctl00_phG_grid_lv0_es", "Warehouse", grid.Locator, "SiteID");
                    SiteID.DataField = "SiteID";
                    IsPromotionalPrice = new CheckBox("ctl00_phG_grid_ef", "Promotion", grid.Locator, "IsPromotionalPrice");
                    IsPromotionalPrice.DataField = "IsPromotionalPrice";
                    IsFairValue = new CheckBox("ctl00_phG_grid", "Fair Value", grid.Locator, "IsFairValue");
                    IsFairValue.DataField = "IsFairValue";
                    IsProrated = new CheckBox("ctl00_phG_grid", "Prorated", grid.Locator, "IsProrated");
                    IsProrated.DataField = "IsProrated";
                    BreakQty = new PXNumberEdit("_ctl00_phG_grid_lv0_edBreakQty", "Break Qty", grid.Locator, "BreakQty");
                    BreakQty.DataField = "BreakQty";
                    SalesPrice = new PXNumberEdit("_ctl00_phG_grid_lv0_edSalesPrice", "Price", grid.Locator, "SalesPrice");
                    SalesPrice.DataField = "SalesPrice";
                    CuryID = new Selector("_ctl00_phG_grid_lv0_es", "Currency", grid.Locator, "CuryID");
                    CuryID.DataField = "CuryID";
                    TaxID = new Selector("_ctl00_phG_grid_lv0_es", "Tax", grid.Locator, "TaxID");
                    TaxID.DataField = "TaxID";
                    EffectiveDate = new DateSelector("_ctl00_phG_grid_lv0_ed16", "Effective Date", grid.Locator, "EffectiveDate");
                    EffectiveDate.DataField = "EffectiveDate";
                    ExpirationDate = new DateSelector("_ctl00_phG_grid_lv0_ed17", "Expiration Date", grid.Locator, "ExpirationDate");
                    ExpirationDate.DataField = "ExpirationDate";
                    RecordID = new PXNumberEdit("ctl00_phG_grid_en", "RecordID", grid.Locator, "RecordID");
            ...
            public class c_grid_header : GridHeader
            {
				...
				public DropDownColumnFilter PriceType { get; }
				public SelectorColumnFilter PriceCode { get; }
				...
				public CheckBoxColumnFilter IsPromotionalPrice { get; }
				public CheckBoxColumnFilter IsFairValue { get; }
				public CheckBoxColumnFilter IsProrated { get; }
				public PXNumberEditColumnFilter BreakQty { get; }
				public PXNumberEditColumnFilter SalesPrice { get; }
                        ...
                        base(grid)
                {
                    ...
                    PriceType = new DropDownColumnFilter(grid.Row.PriceType);
                    PriceCode = new SelectorColumnFilter(grid.Row.PriceCode);
                    ...
                    IsPromotionalPrice = new CheckBoxColumnFilter(grid.Row.IsPromotionalPrice);
                    IsFairValue = new CheckBoxColumnFilter(grid.Row.IsFairValue);
                    IsProrated = new CheckBoxColumnFilter(grid.Row.IsProrated);
                    BreakQty = new PXNumberEditColumnFilter(grid.Row.BreakQty);
                    SalesPrice = new PXNumberEditColumnFilter(grid.Row.SalesPrice);
        ...
        public class c_records_lv0 : Container
        {
			...
			public Label InventoryIDLabel { get; }
			public PXNumberEdit BreakQty { get; }
			public Label BreakQtyLabel { get; }
			public PXNumberEdit SalesPrice { get; }
			public Label SalesPriceLabel { get; }
			public Selector Es { get; }
			public Label EsLabel { get; }
            ...
            public c_records_lv0(string locator, string name) : 
                    base(locator, name)
            {
                PriceCode = new Selector("ctl00_phG_grid_lv0_edPriceCode", "Price Code", locator, null);
                PriceCodeLabel = new Label(PriceCode);
                PriceCode.DataField = "PriceCode";
                InventoryID = new Selector("ctl00_phG_grid_lv0_edInventoryID", "Inventory ID", locator, null);
                InventoryIDLabel = new Label(InventoryID);
                InventoryID.DataField = "InventoryID";
                BreakQty = new PXNumberEdit("ctl00_phG_grid_lv0_edBreakQty", "Break Qty", locator, null);
                BreakQtyLabel = new Label(BreakQty);
                BreakQty.DataField = "BreakQty";
                SalesPrice = new PXNumberEdit("ctl00_phG_grid_lv0_edSalesPrice", "Price", locator, null);
                SalesPriceLabel = new Label(SalesPrice);
                SalesPrice.DataField = "SalesPrice";
