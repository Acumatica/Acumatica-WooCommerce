    ...
    public class AR201000_CustomerClassMaint : Wrapper
    {
        ...
        public class PxToolBar : PxControlCollection
        {
            ...
            public PxToolBar(string locator)
            {
                ...
                ResetGroup = new ToolBarButton("css=li[data-cmd=\'ActionsMenu@ResetGroup\']", "Include Customers to Restriction Group", locator, Actions);
                ResetGroup.WaitAction = Wait.WaitForLongOperationToComplete;
                ResetGroupHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'ResetGroup\']", "Include Customers to Restriction Group", locator, null);
        ...
        public class c_mapping_grid : Grid<c_mapping_grid.c_grid_row, c_mapping_grid.c_grid_header>
        {
			...
			public Button AttributeIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    AttributeIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                }
            }
