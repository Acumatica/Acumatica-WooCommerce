...
namespace ACBC.Tests.Wrappers
{
    ...
    public class BC201000_BCBigCommerceStoreMaint : Wrapper
    {
        ...
        protected c_currentbindingbigcommerce_tab CurrentBindingBigCommerce_tab { get; } = new c_currentbindingbigcommerce_tab("ctl00_phG_tab", "CurrentBindingBigCommerce_tab");
        ...
        public BC201000_BCBigCommerceStoreMaint()
        {
            ScreenId = "BC201000";
            ScreenUrl = "/Pages/BC/BC201000.aspx";
            ToolBar = new PxToolBar(null);
        }
        
        public virtual BC201000_BCBigCommerceStoreMaint ReadOne(Gate gate, string ConnectorType, string BindingName)
        {
            new BiObject<BC201000_BCBigCommerceStoreMaint>(gate).ReadOne(this, ConnectorType, BindingName);
            return this;
        }
        
        public virtual BC201000_BCBigCommerceStoreMaint ReadOne(string ConnectorType, string BindingName)
        {
        ...
        public class c_currentstore_tab : Container
        {
			...
			public DropDown RelatedItems { get; }
			...
			public Selector GiftCertificateItemID { get; }
			public Label GiftCertificateItemIDLabel { get; }
                    ...
                    base(locator, name)
            {
                ...
                StockSalesCategoriesIDs.Items.Add("2", "Food Items");
                StockSalesCategoriesIDs.Items.Add("3", "Electronics");
                StockSalesCategoriesIDs.Items.Add("4", "Software");
                StockSalesCategoriesIDs.Items.Add("5", "Office Electronics");
                StockSalesCategoriesIDs.Items.Add("6", "Industrial Equipment");
                StockSalesCategoriesIDs.Items.Add("7", "Consumer Goods");
                StockSalesCategoriesIDs.Items.Add("8", "Computers");
                StockSalesCategoriesIDs.Items.Add("9", "Laptops");
                StockSalesCategoriesIDs.Items.Add("10", "Laptop Motherboard");
                ...
                NonStockSalesCategoriesIDs.Items.Add("2", "Food Items");
                NonStockSalesCategoriesIDs.Items.Add("3", "Electronics");
                NonStockSalesCategoriesIDs.Items.Add("4", "Software");
                NonStockSalesCategoriesIDs.Items.Add("5", "Office Electronics");
                NonStockSalesCategoriesIDs.Items.Add("6", "Industrial Equipment");
                NonStockSalesCategoriesIDs.Items.Add("7", "Consumer Goods");
                NonStockSalesCategoriesIDs.Items.Add("8", "Computers");
                NonStockSalesCategoriesIDs.Items.Add("9", "Laptops");
                NonStockSalesCategoriesIDs.Items.Add("10", "Laptop Motherboard");
                RelatedItems = new DropDown("ctl00_phG_tab_t3_CstPXDropDown121", "Related Items", locator, null);
                RelatedItemsLabel = new Label(RelatedItems);
                RelatedItems.DataField = "RelatedItems";
                RelatedItems.Items.Add("CSELL", "Cross-Sell");
                RelatedItems.Items.Add("RLTD", "Related");
                RelatedItems.Items.Add("USELL", "Up-Sell");
                ...
                GiftCertificateItemID = new Selector("ctl00_phG_tab_t4_CstPXSelector81", "Gift Certificate Item", locator, null);
                GiftCertificateItemIDLabel = new Label(GiftCertificateItemID);
                GiftCertificateItemID.DataField = "GiftCertificateItemID";
            ...
            public virtual void GiftCertificateItemIDEdit()
            {
                Buttons.GiftCertificateItemIDEdit.Click();
            }
			...
			public Button GiftCertificateItemIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    GiftCertificateItemIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t4_CstPXSelector81\'] div[class=\'editBtnCont\'] > div > d" +
                            "iv", "GiftCertificateItemIDEdit", "ctl00_phG_tab");
                    GiftCertificateItemIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                }
            }
        }
        
        public class c_currentbindingbigcommerce_tab : Container
        {
			...
			public PXTextEdit StoreWDAVServerUrl { get; }
			public Label StoreWDAVServerUrlLabel { get; }
			public PXTextEdit StoreWDAVClientUser { get; }
			public Label StoreWDAVClientUserLabel { get; }
			public PXTextEdit StoreWDAVClientPass { get; }
			public Label StoreWDAVClientPassLabel { get; }
			public PXTextEdit BigCommerceDefaultCurrency { get; }
			public Label BigCommerceDefaultCurrencyLabel { get; }
			public PXTextEdit BigCommerceStoreTimeZone { get; }
			public Label BigCommerceStoreTimeZoneLabel { get; }
            
            public c_currentbindingbigcommerce_tab(string locator, string name) : 
                    base(locator, name)
            {
                StoreAdminUrl = new PXTextEdit("ctl00_phG_tab_t0_CstPXTextEdit60", "Store Admin Path", locator, null);
                StoreAdminUrlLabel = new Label(StoreAdminUrl);
                StoreAdminUrl.DataField = "StoreAdminUrl";
                StoreBaseURL = new PXTextEdit("ctl00_phG_tab_t0_edStoreBaseURL", "API Path", locator, null);
                StoreBaseURLLabel = new Label(StoreBaseURL);
                StoreBaseURL.DataField = "StoreBaseURL";
                StoreXAuthClient = new PXTextEdit("ctl00_phG_tab_t0_edStoreXAuthClient", "Client ID", locator, null);
                StoreXAuthClientLabel = new Label(StoreXAuthClient);
                StoreXAuthClient.DataField = "StoreXAuthClient";
                StoreXAuthToken = new PXTextEdit("ctl00_phG_tab_t0_edStoreXAuthToken", "Access Token", locator, null);
                StoreXAuthTokenLabel = new Label(StoreXAuthToken);
                StoreXAuthToken.DataField = "StoreXAuthToken";
                StoreWDAVServerUrl = new PXTextEdit("ctl00_phG_tab_t0_CstPXTextEdit8", "WebDAV Path", locator, null);
                StoreWDAVServerUrlLabel = new Label(StoreWDAVServerUrl);
                StoreWDAVServerUrl.DataField = "StoreWDAVServerUrl";
                StoreWDAVClientUser = new PXTextEdit("ctl00_phG_tab_t0_edStoreWDAVClientUser", "WebDAV Username", locator, null);
                StoreWDAVClientUserLabel = new Label(StoreWDAVClientUser);
                StoreWDAVClientUser.DataField = "StoreWDAVClientUser";
                StoreWDAVClientPass = new PXTextEdit("ctl00_phG_tab_t0_edStoreWDAVClientPass", "WebDAV Password", locator, null);
                StoreWDAVClientPassLabel = new Label(StoreWDAVClientPass);
                StoreWDAVClientPass.DataField = "StoreWDAVClientPass";
                BigCommerceDefaultCurrency = new PXTextEdit("ctl00_phG_tab_t0_edBigCommerceDefaultCurrency", "Default Currency", locator, null);
                BigCommerceDefaultCurrencyLabel = new Label(BigCommerceDefaultCurrency);
                BigCommerceDefaultCurrency.DataField = "BigCommerceDefaultCurrency";
                BigCommerceStoreTimeZone = new PXTextEdit("ctl00_phG_tab_t0_edBigCommerceStoreTimeZone", "Store Time Zone", locator, null);
                BigCommerceStoreTimeZoneLabel = new Label(BigCommerceStoreTimeZone);
                BigCommerceStoreTimeZone.DataField = "BigCommerceStoreTimeZone";
                DataMemberName = "CurrentBindingBigCommerce";
            }
        }
        ...
        public class c_currentbinding_tab : Container
        {
            ...
            public c_currentbinding_tab(string locator, string name) : 
                    base(locator, name)
            {
                LocaleName = new Selector("ctl00_phG_tab_t0_CstPXSelector120", "Locale", locator, null);
        ...
        public class c_paymentmethods_paymentsmethods : Grid<c_paymentmethods_paymentsmethods.c_grid_row, c_paymentmethods_paymentsmethods.c_grid_header>
        {
			...
			public PXTextEdit StoreOrderPaymentMethod { get; }
			public CheckBox CreatePaymentfromOrder { get; }
			public PXNumberEdit PaymentMappingID { get; }
                        ...
                        base(grid)
                {
                    ...
                    StoreOrderPaymentMethod = new PXTextEdit("ctl00_phG_tab_t5_PaymentsMethods_ei", "Store Order Payment Method", grid.Locator, "StoreOrderPaymentMethod");
                    StoreOrderPaymentMethod.DataField = "StoreOrderPaymentMethod";
                    CreatePaymentfromOrder = new CheckBox("ctl00_phG_tab_t5_PaymentsMethods_ef", "Create Payment from Order", grid.Locator, "CreatePaymentfromOrder");
                    CreatePaymentfromOrder.DataField = "CreatePaymentfromOrder";
            ...
            public class c_grid_header : GridHeader
            {
				...
				public PXTextEditColumnFilter StoreOrderPaymentMethod { get; }
				public CheckBoxColumnFilter CreatePaymentfromOrder { get; }
                        ...
                        base(grid)
                {
                    ...
                    StoreOrderPaymentMethod = new PXTextEditColumnFilter(grid.Row.StoreOrderPaymentMethod);
                    CreatePaymentfromOrder = new CheckBoxColumnFilter(grid.Row.CreatePaymentfromOrder);
        ...
        public class c_multicurrency_lv0 : Container
        {
            ...
            public c_multicurrency_lv0(string locator, string name) : 
                    base(locator, name)
            {
                CashAccount = new Selector("ctl00_phG_tab_t5_gridMultiCurrency_lv0_CstPXSelector108", "Cash Account", locator, null);
        ...
        public class c_shippingmappings_shippingmappings : Grid<c_shippingmappings_shippingmappings.c_grid_row, c_shippingmappings_shippingmappings.c_grid_header>
        {
			...
			public Button Last { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    ReturnOrderTypeEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                    GiftCertificateItemIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t4_CstPXSelector81\'] div[class=\'editBtnCont\'] > div > d" +
                            "iv", "GiftCertificateItemIDEdit", "ctl00_phG_tab_t4_ShippingMappings");
                    GiftCertificateItemIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
        ...
        public class c_shippingmappings_lv0 : Container
        {
			...
			public Button Last { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    ReturnOrderTypeEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                    GiftCertificateItemIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t4_CstPXSelector81\'] div[class=\'editBtnCont\'] > div > d" +
                            "iv", "GiftCertificateItemIDEdit", "ctl00_phG_tab_t4_ShippingMappings_lv0");
                    GiftCertificateItemIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
