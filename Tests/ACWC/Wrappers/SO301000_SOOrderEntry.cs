...
namespace GeneratedWrappers.Acumatica
{
    ...
    public class SO301000_SOOrderEntry : Wrapper
    {
        ...
        public virtual void EmailQuoteHidden()
        {
            ToolBar.EmailQuoteHidden.Click();
        }
        ...
        public virtual void CreateVendorReturnHidden()
        {
            ToolBar.CreateVendorReturnHidden.Click();
        }
        
        public virtual void CreateVendorReturnHidden(bool status, string message = null)
        {
            ToolBar.CreateVendorReturnHidden.WaitActionOverride = () => Wait.WaitForLongOperationToComplete(status, message);
            ToolBar.CreateVendorReturnHidden.Click();
        }
        ...
        public virtual void PrintQuoteHidden()
        {
            ToolBar.PrintQuoteHidden.Click();
        }
        ...
        public virtual void RemoveRiskHoldHidden()
        {
            ToolBar.RemoveRiskHoldHidden.Click();
        }
        
        public virtual void RiskHoldHidden()
        {
            ToolBar.RiskHoldHidden.Click();
        }
        ...
        public virtual void RemoveRiskHold()
        {
            ToolBar.RemoveRiskHold.Click();
        }
        
        public virtual void RiskHold()
        {
            ToolBar.RiskHold.Click();
        }
        ...
        public class PxToolBar : PxControlCollection
        {
			...
			public ToolBarButton EmailQuoteHidden { get; }
			...
			public ToolBarButton CreateVendorReturnHidden { get; }
			...
			public ToolBarButton PrintQuoteHidden { get; }
			public ToolBarButton ApproveHidden { get; }
			public ToolBarButton RejectHidden { get; }
			public ToolBarButton RemoveRiskHoldHidden { get; }
			public ToolBarButton RiskHoldHidden { get; }
			...
			public ToolBarButton RemoveRiskHold { get; }
			public ToolBarButton RiskHold { get; }
            ...
            public PxToolBar(string locator)
            {
                ...
                EmailSalesOrderHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'EmailSalesOrder\']", "Email Sales Order", locator, null);
                EmailQuoteHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'EmailQuote\']", "Email Quote", locator, null);
                ReleaseFromCreditHoldHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'ReleaseFromCreditHold\']", "Remove Credit Hold", locator, null);
                ...
                CreateVendorReturnHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'CreateVendorReturn\']", "Create Vendor Return", locator, null);
                CreateVendorReturnHidden.WaitAction = Wait.WaitForLongOperationToComplete;
                ...
                PutOnHoldHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'PutOnHold\']", "Hold", locator, null);
                ReleaseFromHoldHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'ReleaseFromHold\']", "Remove Hold", locator, null);
                CreateAndAuthorizePaymentHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'CreateAndAuthorizePayment\']", "Create and Authorize", locator, null);
                CreateAndCapturePaymentHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'CreateAndCapturePayment\']", "Create and Capture", locator, null);
                PrintSalesOrderHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'PrintSalesOrder\']", "Print Sales Order", locator, null);
                PrintQuoteHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'PrintQuote\']", "Print Quote", locator, null);
                ...
                RemoveRiskHoldHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'RemoveRiskHold\']", "Remove Risk Hold", locator, null);
                RiskHoldHidden = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'RiskHold\']", "Risk Hold", locator, null);
                ...
                EmailSalesOrder = new ToolBarButton("css=li[data-cmd=\'Action@EmailSalesOrder\']", "Email Sales Order", locator, Actions);
                EmailQuote = new ToolBarButton("css=li[data-cmd=\'Action@EmailQuote\']", "Email Quote", locator, Actions);
                ReleaseFromCreditHold = new ToolBarButton("css=li[data-cmd=\'Action@ReleaseFromCreditHold\']", "Remove Credit Hold", locator, Actions);
                ...
                CreateVendorReturn = new ToolBarButton("css=li[data-cmd=\'Action@CreateVendorReturn\']", "Create Vendor Return", locator, Actions);
                ...
                PutOnHold = new ToolBarButton("css=li[data-cmd=\'Action@PutOnHold\']", "Hold", locator, Actions);
                ReleaseFromHold = new ToolBarButton("css=li[data-cmd=\'Action@ReleaseFromHold\']", "Remove Hold", locator, Actions);
                ...
                CreateAndAuthorizePayment = new ToolBarButton("css=li[data-cmd=\'Action@CreateAndAuthorizePayment\']", "Create and Authorize", locator, Actions);
                CreateAndCapturePayment = new ToolBarButton("css=li[data-cmd=\'Action@CreateAndCapturePayment\']", "Create and Capture", locator, Actions);
                ...
                RemoveRiskHold = new ToolBarButton("css=li[data-cmd=\'Action@RemoveRiskHold\']", "Remove Risk Hold", locator, Actions);
                RiskHold = new ToolBarButton("css=li[data-cmd=\'Action@RiskHold\']", "Risk Hold", locator, Actions);
                ...
                PrintSalesOrder = new ToolBarButton("css=li[data-cmd=\'Report@PrintSalesOrder\']", "Print Sales Order", locator, Reports);
                PrintQuote = new ToolBarButton("css=li[data-cmd=\'Report@PrintQuote\']", "Print Quote", locator, Reports);
                ...
                SyncPaymentTransaction = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'SyncPaymentTransaction\']", "SyncPaymentTransaction", locator, null);
        ...
        public class c_billing_contact_formc : Container
        {
                    ...
                    base(locator, name)
            {
                ...
                FullName = new PXTextEdit("ctl00_phG_tab_t6_formC_edFullName", "Company Name", locator, null);
        ...
        public class c_shipping_contact_formd : Container
        {
                    ...
                    base(locator, name)
            {
                ...
                OverrideContactLabel = new Label(OverrideContact);
                OverrideContact.DataField = "OverrideContact";
                FullName = new PXTextEdit("ctl00_phG_tab_t6_formD_edFullName", "Company Name", locator, null);
                FullNameLabel = new Label(FullName);
                FullName.DataField = "FullName";
        ...
        public class c_orderrisks_gridorderrisks : Grid<c_orderrisks_gridorderrisks.c_grid_row, c_orderrisks_gridorderrisks.c_grid_header>
        {
			...
			public PXTextEdit OrderNbr { get; }
                ...
                public c_grid_row(c_orderrisks_gridorderrisks grid) : 
                        base(grid)
                {
                    LineNbr = new PXNumberEdit("ctl00_phG_tab_t11_gridOrderRisks_en", "Line Nbr.", grid.Locator, "LineNbr");
                    LineNbr.DataField = "LineNbr";
                    Score = new PXNumberEdit("ctl00_phG_tab_t11_gridOrderRisks_en", "Score %", grid.Locator, "Score");
                    ...
                    OrderType = new PXTextEdit("ctl00_phG_tab_t11_gridOrderRisks_ei", "OrderType", grid.Locator, "OrderType");
                    OrderType.DataField = "OrderType";
                    OrderNbr = new PXTextEdit("ctl00_phG_tab_t11_gridOrderRisks_ei", "OrderNbr", grid.Locator, "OrderNbr");
                    OrderNbr.DataField = "OrderNbr";
                }
            }
            ...
            public class c_grid_header : GridHeader
            {
				...
				public PXNumberEditColumnFilter LineNbr { get; }
				public PXNumberEditColumnFilter Score { get; }
                ...
                {
                    LineNbr = new PXNumberEditColumnFilter(grid.Row.LineNbr);
                    Score = new PXNumberEditColumnFilter(grid.Row.Score);
