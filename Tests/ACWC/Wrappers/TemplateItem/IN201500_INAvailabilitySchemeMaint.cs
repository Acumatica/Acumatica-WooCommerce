...
namespace ACBC.Tests.Wrappers
{
    ...
    public class IN201500_INAvailabilitySchemeMaint : Wrapper
    {
        
        public PxToolBar ToolBar;
        
        protected c_schemes_form Schemes_form { get; } = new c_schemes_form("ctl00_phF_form", "Schemes_form");
        ...
        public IN201500_INAvailabilitySchemeMaint()
        {
            ScreenId = "IN201500";
            ScreenUrl = "/Pages/IN/IN201500.aspx";
            ToolBar = new PxToolBar(null);
        }
        
        public virtual IN201500_INAvailabilitySchemeMaint ReadOne(Gate gate, string AvailabilitySchemeID)
        {
            new BiObject<IN201500_INAvailabilitySchemeMaint>(gate).ReadOne(this, AvailabilitySchemeID);
            return this;
        }
        
        public virtual IN201500_INAvailabilitySchemeMaint ReadOne(string AvailabilitySchemeID)
        {
            return this.ReadOne(ApiConnection.Source, AvailabilitySchemeID);
        }
        ...
        public class c_schemes_form : Container
        {
			...
			public CheckBox InclQtyINIssues { get; }
			public Label InclQtyINIssuesLabel { get; }
			public CheckBox InclQtySOPrepared { get; }
			public Label InclQtySOPreparedLabel { get; }
			public CheckBox InclQtySOBooked { get; }
			public Label InclQtySOBookedLabel { get; }
			public CheckBox InclQtySOShipped { get; }
			public Label InclQtySOShippedLabel { get; }
			public CheckBox InclQtySOShipping { get; }
			public Label InclQtySOShippingLabel { get; }
			public CheckBox InclQtyINAssemblyDemand { get; }
			public Label InclQtyINAssemblyDemandLabel { get; }
			public CheckBox InclQtySOBackOrdered { get; }
			public Label InclQtySOBackOrderedLabel { get; }
			public CheckBox InclQtyFSSrvOrdPrepared { get; }
			public Label InclQtyFSSrvOrdPreparedLabel { get; }
			public CheckBox InclQtyFSSrvOrdBooked { get; }
			public Label InclQtyFSSrvOrdBookedLabel { get; }
			public CheckBox InclQtyProductionDemandPrepared { get; }
			public Label InclQtyProductionDemandPreparedLabel { get; }
			public CheckBox InclQtyProductionDemand { get; }
			public Label InclQtyProductionDemandLabel { get; }
			public CheckBox InclQtyProductionAllocated { get; }
			public Label InclQtyProductionAllocatedLabel { get; }
			public CheckBox InclQtyFSSrvOrdAllocated { get; }
			public Label InclQtyFSSrvOrdAllocatedLabel { get; }
			public CheckBox InclQtyINReceipts { get; }
			public Label InclQtyINReceiptsLabel { get; }
			public CheckBox InclQtyInTransit { get; }
			public Label InclQtyInTransitLabel { get; }
			public CheckBox InclQtyPOReceipts { get; }
			public Label InclQtyPOReceiptsLabel { get; }
			public CheckBox InclQtyPOPrepared { get; }
			public Label InclQtyPOPreparedLabel { get; }
			public CheckBox InclQtyPOOrders { get; }
			public Label InclQtyPOOrdersLabel { get; }
			public CheckBox InclQtyINAssemblySupply { get; }
			public Label InclQtyINAssemblySupplyLabel { get; }
			public CheckBox InclQtySOReverse { get; }
			public Label InclQtySOReverseLabel { get; }
			public CheckBox InclQtyProductionSupplyPrepared { get; }
			public Label InclQtyProductionSupplyPreparedLabel { get; }
			public CheckBox InclQtyProductionSupply { get; }
			public Label InclQtyProductionSupplyLabel { get; }
            
            public c_schemes_form(string locator, string name) : 
                    base(locator, name)
            {
                AvailabilitySchemeID = new Selector("ctl00_phF_form_edAvailabilitySchemeID", "Availability Calculation Rule", locator, null);
                ...
                InclQtyINIssues = new CheckBox("ctl00_phF_form_chkInclQtyINIssues", "Deduct Qty. on Issues", locator, null);
                InclQtyINIssuesLabel = new Label(InclQtyINIssues);
                InclQtyINIssues.DataField = "InclQtyINIssues";
                InclQtySOPrepared = new CheckBox("ctl00_phF_form_chkInclQtySOPrepared", "Deduct Qty. on Sales Prepared", locator, null);
                InclQtySOPreparedLabel = new Label(InclQtySOPrepared);
                InclQtySOPrepared.DataField = "InclQtySOPrepared";
                InclQtySOBooked = new CheckBox("ctl00_phF_form_chkInclQtySOBooked", "Deduct Qty. on Sales Orders", locator, null);
                InclQtySOBookedLabel = new Label(InclQtySOBooked);
                InclQtySOBooked.DataField = "InclQtySOBooked";
                InclQtySOShipped = new CheckBox("ctl00_phF_form_chkInclQtySOShipped", "Deduct Qty. Shipped", locator, null);
                InclQtySOShippedLabel = new Label(InclQtySOShipped);
                InclQtySOShipped.DataField = "InclQtySOShipped";
                InclQtySOShipping = new CheckBox("ctl00_phF_form_chkInclQtySOShipping", "Deduct Qty. Allocated", locator, null);
                InclQtySOShippingLabel = new Label(InclQtySOShipping);
                InclQtySOShipping.DataField = "InclQtySOShipping";
                InclQtyINAssemblyDemand = new CheckBox("ctl00_phF_form_chkInclQtyINAssemblyDemand", "Deduct Qty. of Kit Assembly Demand", locator, null);
                InclQtyINAssemblyDemandLabel = new Label(InclQtyINAssemblyDemand);
                InclQtyINAssemblyDemand.DataField = "InclQtyINAssemblyDemand";
                InclQtySOBackOrdered = new CheckBox("ctl00_phF_form_chkInclQtySOBackOrdered", "Deduct Qty. on Back Orders", locator, null);
                InclQtySOBackOrderedLabel = new Label(InclQtySOBackOrdered);
                InclQtySOBackOrdered.DataField = "InclQtySOBackOrdered";
                InclQtyFSSrvOrdPrepared = new CheckBox("ctl00_phF_form_chkInclQtyFSSrvOrdPrepared", "Deduct Qty. on Service Orders Prepared", locator, null);
                InclQtyFSSrvOrdPreparedLabel = new Label(InclQtyFSSrvOrdPrepared);
                InclQtyFSSrvOrdPrepared.DataField = "InclQtyFSSrvOrdPrepared";
                InclQtyFSSrvOrdBooked = new CheckBox("ctl00_phF_form_chkInclQtyFSSrvOrdBooked", "Deduct Qty. on Service Orders", locator, null);
                InclQtyFSSrvOrdBookedLabel = new Label(InclQtyFSSrvOrdBooked);
                InclQtyFSSrvOrdBooked.DataField = "InclQtyFSSrvOrdBooked";
                InclQtyProductionDemandPrepared = new CheckBox("ctl00_phF_form_chkInclQtyProductionDemandPrepared", "Deduct Qty. on Production Demand Prepared", locator, null);
                InclQtyProductionDemandPreparedLabel = new Label(InclQtyProductionDemandPrepared);
                InclQtyProductionDemandPrepared.DataField = "InclQtyProductionDemandPrepared";
                InclQtyProductionDemand = new CheckBox("ctl00_phF_form_chkInclQtyProductionDemand", "Deduct Qty. on Production Demand", locator, null);
                InclQtyProductionDemandLabel = new Label(InclQtyProductionDemand);
                InclQtyProductionDemand.DataField = "InclQtyProductionDemand";
                InclQtyProductionAllocated = new CheckBox("ctl00_phF_form_chkInclQtyProductionAllocated", "Deduct Qty. on Production Allocated", locator, null);
                InclQtyProductionAllocatedLabel = new Label(InclQtyProductionAllocated);
                InclQtyProductionAllocated.DataField = "InclQtyProductionAllocated";
                InclQtyFSSrvOrdAllocated = new CheckBox("ctl00_phF_form_chkInclQtyFSSrvOrdAllocated", "Deduct Qty. Allocated for Service Orders", locator, null);
                InclQtyFSSrvOrdAllocatedLabel = new Label(InclQtyFSSrvOrdAllocated);
                InclQtyFSSrvOrdAllocated.DataField = "InclQtyFSSrvOrdAllocated";
                InclQtyINReceipts = new CheckBox("ctl00_phF_form_chkInclQtyINReceipts", "Include Qty. on Receipts", locator, null);
                InclQtyINReceiptsLabel = new Label(InclQtyINReceipts);
                InclQtyINReceipts.DataField = "InclQtyINReceipts";
                InclQtyInTransit = new CheckBox("ctl00_phF_form_chkInclQtyInTransit", "Include Qty. in Transit", locator, null);
                InclQtyInTransitLabel = new Label(InclQtyInTransit);
                InclQtyInTransit.DataField = "InclQtyInTransit";
                InclQtyPOReceipts = new CheckBox("ctl00_phF_form_chkInclQtyPOReceipts", "Include Qty. on PO Receipts", locator, null);
                InclQtyPOReceiptsLabel = new Label(InclQtyPOReceipts);
                InclQtyPOReceipts.DataField = "InclQtyPOReceipts";
                InclQtyPOPrepared = new CheckBox("ctl00_phF_form_chkInclQtyPOPrepared", "Include Qty. on Purchase Prepared", locator, null);
                InclQtyPOPreparedLabel = new Label(InclQtyPOPrepared);
                InclQtyPOPrepared.DataField = "InclQtyPOPrepared";
                InclQtyPOOrders = new CheckBox("ctl00_phF_form_chkInclQtyPOOrders", "Include Qty. on Purchase Orders", locator, null);
                InclQtyPOOrdersLabel = new Label(InclQtyPOOrders);
                InclQtyPOOrders.DataField = "InclQtyPOOrders";
                InclQtyINAssemblySupply = new CheckBox("ctl00_phF_form_chkInclQtyINAssemblySupply", "Include Qty. of Kit Assembly Supply", locator, null);
                InclQtyINAssemblySupplyLabel = new Label(InclQtyINAssemblySupply);
                InclQtyINAssemblySupply.DataField = "InclQtyINAssemblySupply";
                InclQtySOReverse = new CheckBox("ctl00_phF_form_chkInclQtySOReverse", "Include Qty. on Sales Returns", locator, null);
                InclQtySOReverseLabel = new Label(InclQtySOReverse);
                InclQtySOReverse.DataField = "InclQtySOReverse";
                InclQtyProductionSupplyPrepared = new CheckBox("ctl00_phF_form_chkInclQtyProductionSupplyPrepared", "Include Qty. of Production Supply Prepared", locator, null);
                InclQtyProductionSupplyPreparedLabel = new Label(InclQtyProductionSupplyPrepared);
                InclQtyProductionSupplyPrepared.DataField = "InclQtyProductionSupplyPrepared";
                InclQtyProductionSupply = new CheckBox("ctl00_phF_form_chkInclQtyProductionSupply", "Include Qty. of Production Supply", locator, null);
                InclQtyProductionSupplyLabel = new Label(InclQtyProductionSupply);
                InclQtyProductionSupply.DataField = "InclQtyProductionSupply";
                DataMemberName = "Schemes";
            }
        }
