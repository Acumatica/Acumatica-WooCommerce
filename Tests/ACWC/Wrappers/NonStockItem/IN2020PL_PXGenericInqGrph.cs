...
namespace ACSC.Tests.Wrappers.NonStockItem
{
    
    
    public class IN2020PL_PXGenericInqGrph : Wrapper
    {
        ...
        public IN2020PL_PXGenericInqGrph()
        {
            ScreenId = "IN2020PL";
            ScreenUrl = "/GenericInquiry/GenericInquiry.aspx?id=f011f598-2597-4d03-b836-b1137ed1c275";
        ...
        public class c_results_grid : Grid<c_results_grid.c_grid_row, c_results_grid.c_grid_header>
        {
			...
			public Selector BAccountR_AcctCD { get; }
                        ...
                        base(grid)
                {
                    ...
                    InventoryItem_createdDateTime = new DateSelector("_ctl00_phG_grid_lv0_ed25", "Created On", grid.Locator, "InventoryItem_createdDateTime");
                    ...
                    InventoryItem_lastModifiedDateTime = new DateSelector("_ctl00_phG_grid_lv0_ed27", "Last Modified On", grid.Locator, "InventoryItem_lastModifiedDateTime");
