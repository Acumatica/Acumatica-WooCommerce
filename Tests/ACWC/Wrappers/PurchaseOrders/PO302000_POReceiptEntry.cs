...
namespace ACBC.Tests.Wrappers
{
    ...
    public class PO302000_POReceiptEntry : Wrapper
    {
        ...
        public virtual void EmailPurchaseReceipt1()
        {
            ToolBar.EmailPurchaseReceipt1.Click();
        }
        ...
        public virtual void ViewPurchaseReceiptsBillingHistory()
        {
            ToolBar.ViewPurchaseReceiptsBillingHistory.Click();
        }
        
        public virtual void PurchaseReceiptAllocatedAndBackordered()
        {
            ToolBar.PurchaseReceiptAllocatedAndBackordered.Click();
        }
        
        public virtual void AddPOOrder2()
        {
            ToolBar.AddPOOrder2.Click();
        }
        
        public virtual void AddTransfer2()
        {
            ToolBar.AddTransfer2.Click();
        }
        ...
        public class PxToolBar : PxControlCollection
        {
			...
			public ToolBarButton EmailPurchaseReceipt1 { get; }
			public ToolBarButton CreateLCDocument { get; }
			public ToolBarButton Reports { get; }
			public ToolBarButton PrintPurchaseReceipt { get; }
			public ToolBarButton ViewPurchaseReceiptsBillingHistory { get; }
			public ToolBarButton PurchaseReceiptAllocatedAndBackordered { get; }
			public ToolBarButton AddPOOrder2 { get; }
			public ToolBarButton AddTransfer2 { get; }
            ...
            public PxToolBar(string locator)
            {
                ...
                CreateReturn = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'CreateReturn\']", "Return", locator, null);
                ...
                Assign = new ToolBarButton("css=li[data-cmd=\'Action@Assign\']", "Apply Assignment Rules", locator, Actions);
                CreateAPDocument = new ToolBarButton("css=li[data-cmd=\'Action@CreateAPDocument\']", "Enter AP Bill", locator, Actions);
                EmailPurchaseReceipt1 = new ToolBarButton("css=li[data-cmd=\'Action@Email Purchase Receipt\']", "Email Purchase Receipt", locator, Actions);
                CreateLCDocument = new ToolBarButton("css=li[data-cmd=\'Action@CreateLCDocument\']", "Enter Landed Costs", locator, Actions);
                Reports = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div:textEqual(\"Reports\") > div[data-type=\'drop\']", "Reports", locator, null);
                PrintPurchaseReceipt = new ToolBarButton("css=li[data-cmd=\'Report@ Print Purchase Receipt\']", " Print Purchase Receipt", locator, Reports);
                ViewPurchaseReceiptsBillingHistory = new ToolBarButton("css=li[data-cmd=\'Report@View Purchase Receipts Billing History\']", "View Purchase Receipts Billing History", locator, Reports);
                PurchaseReceiptAllocatedAndBackordered = new ToolBarButton("css=li[data-cmd=\'Report@Purchase Receipt Allocated and Backordered\']", "Purchase Receipt Allocated and Backordered", locator, Reports);
                AddPOOrder2 = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'AddPOOrder2\']", "Add PO", locator, null);
                AddTransfer2 = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'AddTransfer2\']", "Add Transfer", locator, null);
                AddINTran = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'AddINTran\']", "Add Transfer Line", locator, null);
                AddINTran2 = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'AddINTran2\']", "Add Transfer Line", locator, null);
        ...
        public class c_document_form : Container
        {
			...
			public CheckBox ReturnOrigCost { get; }
			public Label ReturnOrigCostLabel { get; }
                    ...
                    base(locator, name)
            {
                ...
                ReturnOrigCost = new CheckBox("ctl00_phF_form_t0_chkReturnOrigCost", "Process Return with Original Cost", locator, null);
                ReturnOrigCostLabel = new Label(ReturnOrigCost);
                ReturnOrigCost.DataField = "ReturnOrigCost";
        ...
        public class c_transactions_grid : Grid<c_transactions_grid.c_grid_row, c_transactions_grid.c_grid_header>
        {
			...
			public Button OrigReceiptNbrEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    SOShipmentNbrEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                    ...
                    OrigReceiptNbrEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                }
            }
			...
			public PXTextEdit ReceiptNbr { get; }
                        ...
                        base(grid)
                {
                    ...
                    ReceiptNbr = new PXTextEdit("_ctl00_phG_tab_t0_grid_lv0_edReceiptNbr", "Order Nbr.", grid.Locator, "ReceiptNbr");
                    ReceiptNbr.DataField = "ReceiptNbr";
                }
            }
        ...
        public class c_receiptorderslink_formorders : Grid<c_receiptorderslink_formorders.c_grid_row, c_receiptorderslink_formorders.c_grid_header>
        {
			...
			public PXTextEdit ReceiptNbr { get; }
                        ...
                        base(grid)
                {
                    ...
                    CuryID.DataField = "CuryID";
                    TaxZoneID = new PXTextEdit("ctl00_phG_tab_t1_formOrders_em", "Vendor Tax Zone", grid.Locator, "TaxZoneID");
        ...
        public class c_poreceiptreturn_grdreceiptreturn : Grid<c_poreceiptreturn_grdreceiptreturn.c_grid_row, c_poreceiptreturn_grdreceiptreturn.c_grid_header>
        {
			...
			public PXNumberEdit OrderQty { get; }
                        ...
                        base(grid)
                {
                    ...
                    VendorLocationID.DataField = "VendorLocationID";
                    ReceiptDate = new DateSelector("_ctl00_phG_panelAddReceiptReturn_grdReceiptReturn_lv0_ed5", "Date", grid.Locator, "ReceiptDate");
                    ReceiptDate.DataField = "ReceiptDate";
