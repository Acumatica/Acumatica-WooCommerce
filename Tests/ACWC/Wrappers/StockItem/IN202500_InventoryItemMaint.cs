...
namespace ACBC.Tests.Wrappers
{
    ...
    public class IN202500_InventoryItemMaint : Wrapper
    {
        ...
        protected c_syncrecs_lv0 SyncRecs_lv0 { get; } = new c_syncrecs_lv0("ctl00_phG_tab_t16_syncGrid_lv0", "SyncRecs_lv0");
        ...
        {
            ToolBar.Summary.Click();
        }
        
        public virtual void AllocationDetails()
        {
            ToolBar.AllocationDetails.Click();
        }
        
        public virtual void TransactionSummary()
        {
            ToolBar.TransactionSummary.Click();
        }
        
        public virtual void TransactionDetails()
        {
            ToolBar.TransactionDetails.Click();
        }
        
        public virtual void TransactionHistory()
        {
            ToolBar.TransactionHistory.Click();
        }
        ...
        public class PxToolBar : PxControlCollection
        {
			...
			public ToolBarButton Summary { get; }
			public ToolBarButton AllocationDetails { get; }
			public ToolBarButton TransactionSummary { get; }
			public ToolBarButton TransactionDetails { get; }
			public ToolBarButton TransactionHistory { get; }
            ...
            public PxToolBar(string locator)
            {
                ...
                Summary = new ToolBarButton("css=li[data-cmd=\'Inquiry@Summary\']", "Summary", locator, Inquiries);
                AllocationDetails = new ToolBarButton("css=li[data-cmd=\'Inquiry@Allocation Details\']", "Allocation Details", locator, Inquiries);
                TransactionSummary = new ToolBarButton("css=li[data-cmd=\'Inquiry@Transaction Summary\']", "Transaction Summary", locator, Inquiries);
                TransactionDetails = new ToolBarButton("css=li[data-cmd=\'Inquiry@Transaction Details\']", "Transaction Details", locator, Inquiries);
                TransactionHistory = new ToolBarButton("css=li[data-cmd=\'Inquiry@Transaction History\']", "Transaction History", locator, Inquiries);
                ...
                GenerateLotSerialNumber = new ToolBarButton("css=#ctl00_phDS_ds_ToolBar div[data-cmd=\'GenerateLotSerialNumber\']", "Generate Lot/Serial Number", locator, null);
        ...
        public class c_item_form : Container
        {
			...
			public Label UsrCustom_1Label { get; }
			public PXTextEdit UsrCustom_2 { get; }
			public Label UsrCustom_2Label { get; }
            ...
            public c_item_form(string locator, string name) : 
                    base(locator, name)
            {
                UsrCustom_1 = new PXTextEdit("ctl00_phF_form_CstPXTextEdit1", "Custom_1", locator, null);
                UsrCustom_1Label = new Label(UsrCustom_1);
                UsrCustom_1.DataField = "UsrCustom_1";
                UsrCustom_2 = new PXTextEdit("ctl00_phF_form_CstPXTextEdit2", "Custom_2", locator, null);
                UsrCustom_2Label = new Label(UsrCustom_2);
        ...
        public class c_itemsettings_tab : Container
        {
                    ...
                    base(locator, name)
            {
                ...
                PageTitle = new InputLocalizable("ctl00_phG_tab_t17_edPageTitle", "Page Title", locator, null);
                PageTitleLabel = new Label(PageTitle);
                PageTitle.DataField = "PageTitle";
                ShortDescription = new InputLocalizable("ctl00_phG_tab_t17_edShortDescription", "Short Description", locator, null);
                ShortDescriptionLabel = new Label(ShortDescription);
                ShortDescription.DataField = "ShortDescription";
                SearchKeywords = new InputLocalizable("ctl00_phG_tab_t17_edSearchKeywords", "Search Keywords", locator, null);
                SearchKeywordsLabel = new Label(SearchKeywords);
                SearchKeywords.DataField = "SearchKeywords";
                MetaKeywords = new InputLocalizable("ctl00_phG_tab_t17_edMetaKeywords", "Meta Keywords", locator, null);
                MetaKeywordsLabel = new Label(MetaKeywords);
                MetaKeywords.DataField = "MetaKeywords";
                MetaDescription = new InputLocalizable("ctl00_phG_tab_t17_edMetaDescription", "Meta Description", locator, null);
			...
			public Button AMScrapLocationIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    AMBOMIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_edAMBOMID\'] div[class=\'editBtnCont\'] > div > div", "AMBOMIDEdit", "ctl00_phG_tab");
                    AMBOMIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                    AMPlanningBOMIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_edAMPlanningBOMID\'] div[class=\'editBtnCont\'] > div >" +
        ...
        public class c_itemsettings_formsm : Container
        {
			...
			public Button InventoryIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    ManufacturerIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                    ...
                    ManufacturerModelIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                    ...
                    ClassIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
        ...
        public class c_components_lv0 : Container
        {
			...
			public Button DeferredCodeEdit1 { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    SalesAcctIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                    UOMEdit = new Button("css=div[id=\'ctl00_phG_tab_t11_PXGridComponents_lv0_edUOM\'] div[class=\'editBtnCont" +
        ...
        public class c_itemcosts_formcoststats : Container
        {
                    ...
                    base(locator, name)
            {
                ...
                AvgCost = new PXNumberEdit("ctl00_phG_tab_t2_formCostStats_edAvgCost", "Average Cost", locator, null);
        ...
        public class c_itemsiterecords_grid2 : Grid<c_itemsiterecords_grid2.c_grid_row, c_itemsiterecords_grid2.c_grid_header>
        {
			...
			public PXTextEdit AMReplenishmentSource { get; }
			...
			public Selector InventoryID { get; }
                        ...
                        base(grid)
                {
                    ...
                    AMReplenishmentSource = new PXTextEdit("ctl00_phG_tab_t4_grid2", "Source", grid.Locator, "AMReplenishmentSource");
                    AMReplenishmentSource.DataField = "AMReplenishmentSource";
                    ...
                    LastForecastDate = new DateSelector("_ctl00_phG_tab_t4_grid2_lv0_ed24", "Last Forecast Date", grid.Locator, "LastForecastDate");
            ...
            public class c_grid_header : GridHeader
            {
				...
				public PXTextEditColumnFilter AMReplenishmentSource { get; }
                        ...
                        base(grid)
                {
                    ...
                    AMReplenishmentSource = new PXTextEditColumnFilter(grid.Row.AMReplenishmentSource);
        ...
        public class c_replenishment_repgrid : Grid<c_replenishment_repgrid.c_grid_row, c_replenishment_repgrid.c_grid_header>
        {
			...
			public Button ReplenishmentPolicyIDEdit { get; }
                ...
                public PxButtonCollection()
                {
                    ...
                    ReplenishmentClassIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                    ...
                    ReplenishmentPolicyIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                }
            }
        ...
        public class c_inventoryfileurls_gridinventoryfileurls : Grid<c_inventoryfileurls_gridinventoryfileurls.c_grid_row, c_inventoryfileurls_gridinventoryfileurls.c_grid_header>
        {
			...
			public PXNumberEdit FileID { get; }
                ...
                public c_grid_row(c_inventoryfileurls_gridinventoryfileurls grid) : 
                        base(grid)
                {
                    FileURL = new PXTextEdit("ctl00_phG_tab_t17_gridInventoryFileUrls_ei", "URL", grid.Locator, "FileURL");
                    FileURL.DataField = "FileURL";
                    FileType = new DropDown("_ctl00_phG_tab_t17_gridInventoryFileUrls_lv0_ec", "Type", grid.Locator, "FileType");
                    FileType.DataField = "FileType";
                    FileType.Items.Add("I", "Image");
                    FileType.Items.Add("V", "Video");
                    FileID = new PXNumberEdit("ctl00_phG_tab_t17_gridInventoryFileUrls_en", "FileID", grid.Locator, "FileID");
                    FileID.DataField = "FileID";
                }
            }
        ...
        public class c_syncrecs_syncgrid : Grid<c_syncrecs_syncgrid.c_grid_row, c_syncrecs_syncgrid.c_grid_header>
        {
			...
			public ToolBarButtonGrid Hi1 { get; }
                ...
                public PxToolBar(string locator)
                {
                    ...
                    SyncSalesforce = new ToolBarButtonGrid("css=#ctl00_phG_tab_t16_syncGrid_at_tlb div[data-cmd=\'SyncSalesforce\']", "Sync with Salesforce", locator, null);
			...
			public Selector SyncRecordID { get; }
                ...
                public c_grid_row(c_syncrecs_syncgrid grid) : 
                        base(grid)
                {
                    SYProvider__Name = new Selector("_ctl00_phG_tab_t16_syncGrid_lv0_es", "Data Provider", grid.Locator, "SYProvider__Name");
                    SYProvider__Name.DataField = "SYProvider__Name";
                    RemoteID = new PXTextEdit("ctl00_phG_tab_t16_syncGrid_ei", "Ext. Ref.", grid.Locator, "RemoteID");
                    RemoteID.DataField = "RemoteID";
                    Status = new DropDown("_ctl00_phG_tab_t16_syncGrid_lv0_ec", "Status", grid.Locator, "Status");
                    ...
                    Operation = new DropDown("_ctl00_phG_tab_t16_syncGrid_lv0_ec", "Operation", grid.Locator, "Operation");
                    Operation.DataField = "Operation";
                    Operation.Items.Add("1", "Insert");
                    Operation.Items.Add("2", "Update");
                    Operation.Items.Add("3", "Delete");
                    LastErrorMessage = new PXTextEdit("ctl00_phG_tab_t16_syncGrid_ei", "Error", grid.Locator, "LastErrorMessage");
                    LastErrorMessage.DataField = "LastErrorMessage";
                    LastAttemptTS = new DateSelector("_ctl00_phG_tab_t16_syncGrid_lv0_ed5", "Latest Attempt", grid.Locator, "LastAttemptTS");
                    LastAttemptTS.DataField = "LastAttemptTS";
                    AttemptCount = new PXNumberEdit("ctl00_phG_tab_t16_syncGrid_en", "Attempt Counter", grid.Locator, "AttemptCount");
                    AttemptCount.DataField = "AttemptCount";
                    SFEntitySetup__ImportScenario = new Selector("_ctl00_phG_tab_t16_syncGrid_lv0_es", "Import Scenario", grid.Locator, "SFEntitySetup__ImportScenario");
                    SFEntitySetup__ImportScenario.DataField = "SFEntitySetup__ImportScenario";
                    SFEntitySetup__ExportScenario = new Selector("_ctl00_phG_tab_t16_syncGrid_lv0_es", "Export Scenario", grid.Locator, "SFEntitySetup__ExportScenario");
                    SFEntitySetup__ExportScenario.DataField = "SFEntitySetup__ExportScenario";
                    SyncRecordID = new Selector("_ctl00_phG_tab_t16_syncGrid_lv0_es", "Sync Record ID", grid.Locator, "SyncRecordID");
        ...
        public class c_syncrecs_lv0 : Container
        {
            ...
            public c_syncrecs_lv0(string locator, string name) : 
                    base(locator, name)
            {
                Es = new Selector("ctl00_phG_tab_t16_syncGrid_lv0_es", "Es", locator, null);
                EsLabel = new Label(Es);
                Ed = new DateSelector("ctl00_phG_tab_t16_syncGrid_lv0_ed", "Ed", locator, null);
                EdLabel = new Label(Ed);
                Ec = new DropDown("ctl00_phG_tab_t16_syncGrid_lv0_ec", "Ec", locator, null);
                DataMemberName = "SyncRecs";
            }
        }
        ...
        public class c_amsubitemdefaults_amgridamsubitemdefault : Grid<c_amsubitemdefaults_amgridamsubitemdefault.c_grid_row, c_amsubitemdefaults_amgridamsubitemdefault.c_grid_header>
        {
			...
			public Button Last { get; }
                ...
                public PxButtonCollection()
                {
                    AMBOMIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_edAMBOMID\'] div[class=\'editBtnCont\'] > div > div", "AMBOMIDEdit", "ctl00_phG_tab_t3_AMGridAMSubItemDefault");
                    AMBOMIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                    AMPlanningBOMIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_edAMPlanningBOMID\'] div[class=\'editBtnCont\'] > div >" +
                            " div", "AMPlanningBOMIDEdit", "ctl00_phG_tab_t3_AMGridAMSubItemDefault");
                    AMPlanningBOMIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                    AMConfigurationIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_edAMConfigurationID\'] div[class=\'editBtnCont\'] > div" +
        ...
        public class c_amsubitemdefaults_lv0 : Container
        {
			...
			public Button Last { get; }
                ...
                public PxButtonCollection()
                {
                    AMBOMIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_edAMBOMID\'] div[class=\'editBtnCont\'] > div > div", "AMBOMIDEdit", "ctl00_phG_tab_t3_AMGridAMSubItemDefault_lv0");
                    AMBOMIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                    AMPlanningBOMIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_edAMPlanningBOMID\'] div[class=\'editBtnCont\'] > div >" +
                            " div", "AMPlanningBOMIDEdit", "ctl00_phG_tab_t3_AMGridAMSubItemDefault_lv0");
                    AMPlanningBOMIDEdit.WaitAction = () => Wait.WaitForPageToLoad(true);
                    AMConfigurationIDEdit = new Button("css=div[id=\'ctl00_phG_tab_t3_edAMConfigurationID\'] div[class=\'editBtnCont\'] > div" +
