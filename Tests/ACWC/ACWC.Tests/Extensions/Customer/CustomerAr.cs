...
{
    public class CustomerAr : AR303000_CustomerMaint, ICancelCloseable, ISaveCloseable, ISaveable, ICancelable, IInsertable, IDeleteable, ICopyDocumentable, IPasteDocumentable, ISaveTemplateable
    {
