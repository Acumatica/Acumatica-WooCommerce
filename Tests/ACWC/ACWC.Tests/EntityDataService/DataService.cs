...
namespace ACSC.Tests.EntityDataService
{
    public class DataService
    {
        ...
        //public void GetCustomerTestData(CustomerData customerData)
        //{
        //    var jsonbody = JsonConvert.SerializeObject(customerData, Formatting.Indented, new JsonSerializerSettings
        //    {
        //        NullValueHandling = NullValueHandling.Ignore
        //    });
        //}

        public static CustomerData GetCustomerNew(string fileName)
        {
            return FileReader<JsonFileReader>().Construct(fileName).Get<CustomerData>();
        }

        //public static CustomerData GetCustomerData(CustomerData customerData)
        //{
        //    var jsonbody = JsonConvert.SerializeObject(customerData, Formatting.Indented, new JsonSerializerSettings
        //    {
        //        NullValueHandling = NullValueHandling.Ignore
        ...
        internal static CustomerData GetCustomer(CustomerData newCustomerData)
        {
            throw new NotImplementedException();
        }

        internal static CustomerData GetCustomerNew(CustomerData newCustomerData)
        {
            throw new NotImplementedException();
        }

        //internal static CustomerData GetCustomerTestData()
        //{
        //    throw new NotImplementedException();
        //}
    }
