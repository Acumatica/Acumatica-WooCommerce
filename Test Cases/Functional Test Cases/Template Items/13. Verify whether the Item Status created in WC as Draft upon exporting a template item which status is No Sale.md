...
<p>Status created in WC as Draft upon exporting a template item which status is&nbsp;No Sale</p>
...
<p>1. Make sure the Template Items status in the AC is&nbsp;No Sale</p>
