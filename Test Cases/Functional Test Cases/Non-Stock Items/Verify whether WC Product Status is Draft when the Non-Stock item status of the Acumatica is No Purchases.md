...
<p><span style="color: rgb(51,51,51);">WC Product Status is 'Draft' when the Non-Stock item status of the Acumatica is 'No Purchases'</span></p>
...
<p style="margin-left: 0.0in;">1. Create a Non-Stock item by filling all the mandatory fields<br />2. Acumatica Stock Item Status = '<strong>No Purchases</strong>'<strong>&nbsp;&lt;status&gt;</strong><br />3. Save the record, Prepare and Process<br />4. Open the record in WooCommerce and validate the staus of the product</p>
...
<p style="margin-left: 0.0in;"><span style="color: rgb(51,51,51);"><strong><u><span><br />Test Data</span></u></strong></span></p>
<p style="margin-left: 0.0in;"><span style="color: rgb(51,51,51);"><strong><u><span>&nbsp;</span></u></strong>'<strong>No Purchases</strong>'<br /></span></p>
